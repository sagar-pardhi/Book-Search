...
public class BookDetail extends AppCompatActivity {
    ...
    private TextView tvTitle, tvAuthor, tvPublisher, tvPageCount;
    ...
    private void setShareIntent() {
        ...
        final TextView tvAuthor = (TextView)findViewById(R.id.tvAuthor);
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, (String)tvAuthor.getText());
